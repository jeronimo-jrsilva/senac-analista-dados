# 🎓 Analista de Dados - Senac Centro
## UC4 - Machine Learning e Data Mining (Julho/2026)

Este repositório centraliza os materiais de aula (Notebooks de exercícios e slides das apresentações em PDF) compartilhados com a turma.
...
*   **`Aula_06_Regressao_Linear/`**: Regressão Linear Simples e Múltipla com Scikit-Learn (coeficientes, R² e MSE). (Contém notebook de exercícios, material de referência e slides em PDF).
